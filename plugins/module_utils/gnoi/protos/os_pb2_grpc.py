...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in os_pb2_grpc.py depends on'
...
class OSStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Install = channel.stream_stream(
                '/gnoi.os.OS/Install',
                request_serializer=os__pb2.InstallRequest.SerializeToString,
                response_deserializer=os__pb2.InstallResponse.FromString,
                _registered_method=True)
        self.Activate = channel.unary_unary(
                '/gnoi.os.OS/Activate',
                request_serializer=os__pb2.ActivateRequest.SerializeToString,
                response_deserializer=os__pb2.ActivateResponse.FromString,
                _registered_method=True)
        self.Verify = channel.unary_unary(
                '/gnoi.os.OS/Verify',
                request_serializer=os__pb2.VerifyRequest.SerializeToString,
                response_deserializer=os__pb2.VerifyResponse.FromString,
                _registered_method=True)
...
def add_OSServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Install': grpc.stream_stream_rpc_method_handler(
                    servicer.Install,
                    request_deserializer=os__pb2.InstallRequest.FromString,
                    response_serializer=os__pb2.InstallResponse.SerializeToString,
            ),
            'Activate': grpc.unary_unary_rpc_method_handler(
                    servicer.Activate,
                    request_deserializer=os__pb2.ActivateRequest.FromString,
                    response_serializer=os__pb2.ActivateResponse.SerializeToString,
            ),
            'Verify': grpc.unary_unary_rpc_method_handler(
                    servicer.Verify,
                    request_deserializer=os__pb2.VerifyRequest.FromString,
                    response_serializer=os__pb2.VerifyResponse.SerializeToString,
            ),
    }
...
class OS(object):
    ...
    def Install(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/gnoi.os.OS/Install',
            os__pb2.InstallRequest.SerializeToString,
            os__pb2.InstallResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Activate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnoi.os.OS/Activate',
            os__pb2.ActivateRequest.SerializeToString,
            os__pb2.ActivateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Verify(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnoi.os.OS/Verify',
            os__pb2.VerifyRequest.SerializeToString,
            os__pb2.VerifyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
